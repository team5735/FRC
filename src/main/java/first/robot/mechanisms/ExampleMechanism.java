...
public class ExampleMechanism implements Mechanism {
    ...
    /**
     * An example command that requires this mechanism. Only one command that
     * requires this mechanism may run at a time - if a command is already
     * running, this command will interrupt it.
     *
     * <p>
     * This example runs indefinitely and prints a message every time it
     * executes.
     *
